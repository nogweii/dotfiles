...
mywibox = {}
mystatusbox = awful.wibox({position = "bottom", screen = 1, ontop=
false, width = 1, height = 14})
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "Print", function() awful.util.spawn_with_shell("scrot -e 'mv $f ~/ 2>/dev/null'") end)
)
