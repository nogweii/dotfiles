...
# Mark prompt_git_formatter as a math function so that it can be used in $((...)) expressions
functions -M prompt_git_formatter
...
() {
  ...
  # restarting zsh. Edit and source this file!
  unset -m '(POWERLEVEL9K_*|DEFAULT_USER)~POWERLEVEL9K_GITSTATUS_DIR'

  # Zsh >= 5.1 is required.
  [[ $ZSH_VERSION == (5.<1->*|<6->.*) ]] || {
      echo "yer zsh is too old! need >= 5.1!"
      return
  }
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#198754'
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#b02a37'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#198754'
  ...
  typeset -g POWERLEVEL9K_VCS_BACKGROUND='#653208'
  ...
  typeset -g POWERLEVEL9K_VCS_CONTENT_EXPANSION='${$((prompt_git_formatter(1)))+${_formatted_git_prompt}}'
  typeset -g POWERLEVEL9K_VCS_LOADING_CONTENT_EXPANSION='${$((prompt_git_formatter(0)))+${_formatted_git_prompt}}'
  # Enable counters for staged, unstaged, etc.
  typeset -g POWERLEVEL9K_VCS_{STAGED,UNSTAGED,UNTRACKED,CONFLICTED,COMMITS_AHEAD,COMMITS_BEHIND}_MAX_NUM=-1

  # Override the remote-url specific git icons, always use the official logo
  typeset -g POWERLEVEL9K_VCS_GIT_ICON='󰊢'
  # typeset -g POWERLEVEL9K_VCS_GIT_REMOTE_ICONS=('*' VCS_GIT_ICON)
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR='#f54d27'
  ...
  typeset -g POWERLEVEL9K_DIRENV_BACKGROUND='#6c757d'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_RBENV_BACKGROUND='#CC342D'
  ...
  typeset -g POWERLEVEL9K_RBENV_SHOW_ON_COMMAND='ruby|bundle|rake|irb|gem|ri|rdoc|rbenv|rspec'
